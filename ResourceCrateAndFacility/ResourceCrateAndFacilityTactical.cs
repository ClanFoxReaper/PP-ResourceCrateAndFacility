...
namespace ResourceCrateAndFacility
{
	...
	public class ResourceCrateAndFacilityTacInstanceData
	{
	...
	/// </summary>
	public class ResourceCrateAndFacilityTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			ResourceCrateAndFacilityMain main = (ResourceCrateAndFacilityMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			ResourceCrateAndFacilityTacInstanceData data = (ResourceCrateAndFacilityTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new ResourceCrateAndFacilityTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
