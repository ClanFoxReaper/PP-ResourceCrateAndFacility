...
namespace ResourceCrateAndFacility
{
	...
	public class ResourceCrateAndFacilityGSInstanceData
	{
	...
	/// </summary>
	public class ResourceCrateAndFacilityGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new ResourceCrateAndFacilityGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			ResourceCrateAndFacilityGSInstanceData data = (ResourceCrateAndFacilityGSInstanceData)instanceData;
		}
