...
- ResourceCrateAndFacilityConfig.cs: Example of ModConfig for custom mod settings;
- ResourceCrateAndFacilityGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- ResourceCrateAndFacilityMain.cs: Main mod class, recieves mod management and general events;
- ResourceCrateAndFacilityTactical.cs: Example of ModTactical for modifying tactical level;
